...
<html lang="en">
<head>
    <title>Reason Based Report</title>
        ...
        <div class="main-grid">
            <div class="agile-grids">    
                ...
                <div class="table-heading">
                    <h2 style="color: #00008B;">Reason Based Report</h2>
                </div>
                <div class="agile-tables">
                    <div class="w3l-table-info">
                        <h3>Reason Wise Report</h3>
                        <table id="table" class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    <th>Reason</th>
                                    <th>Pickpocketing-पाकिटमारी</th>
                                    <th>Burglary-घरफोडी</th>
                                    <th>Robbery-दरोडा</th>
                                    <th>Mugging-जबरी चोरी</th>
                                    <th>Vandalism-तोडफोड</th>
                                    <th>Extortion-खंडणी</th>
                                    <th>Smuggling-तस्करी</th>
                                    <th>Fraud-फसवणूक</th>
                                    <th>Carjacking-गाडी लुटणे</th>
                                    <th>Hooliganism-दंगेखोरी</th>
                            ...
                            <tbody>
                                <%
                                    try {
                                        ...
                                        PreparedStatement preparedStatement = connection.prepareStatement("select * from reason_report");
