...
<html>
<head>
    <title>View Black Spots-Police Station | SpotWarn</title>
...
<body class="dashboard-page">
    ...
    <section class="wrapper scrollable">
        ...
        <div class="main-content">
            <h3><b>Search for a particular black spot:</b></h3><br>
            <form action="view_blackspotPolice.jsp" method="get">
                <input type="text" name="p_city" placeholder="Enter city name:">
                <input type="submit" value="View details">
            </form>

            <%-- Check if p_city parameter is set --%>
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    try {
                        ...
                        PreparedStatement ps1 = con.prepareStatement("select * from add_black_spot where p_city=?");
            ...
            <br>
            <h4><u><a href="Delete_Spot.jsp" Style="color:red;">Delete the Black Spot</a></u></h4>
            <br>
