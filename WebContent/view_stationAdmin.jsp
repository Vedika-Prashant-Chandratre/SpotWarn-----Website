<%@page import="com.transaction.BankConnectionAdmin.BankConnection2"%>
<%@page import="java.sql.*"%>
<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1"%>
<!DOCTYPE html>
<html>
<head>
    <title>View Station | View Station :: SpotWarn</title>
...
<body class="dashboard-page">
    ...
    <section class="wrapper scrollable">
        ...
        <section class="title-bar">
            <div class="logo">
                <h1><a href="Welcome.html"><img src="assets/img/Saf1.png" alt="" height="33%" width="33%"/></a></h1>
                <div style="
        position: absolute; 
        top: 30px; 
        width: 100%; 
        ...
        <div class="main-content">
            <h3 style="color: #00008B;">Search for a particular police station:</h3><br>
            <form action="view_station.jsp">
                <input type="text" name="s_name" placeholder="Enter station name:">
            ...
            <table id="table" class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    try {
                        ...
                        PreparedStatement ps1 = con.prepareStatement("select * from p_station");
            ...
            <h1 align="center" >View All Police Stations</h1>
        ...
        <br>
      <h4><a href="Delete_Spot.jsp" Style="color:red;"><u>&nbsp&nbsp Delete the Black Spot</u></a></h4>
        <!-- footer -->
        <div class="footer">
